...
<main>
    ...
    <div class="productos">
        <?php while($zapato = $resultado->fetch_assoc()): ?>
            ...
            <div class="producto">
                <img src="<?= htmlspecialchars($zapato['imagen']) ?>" alt="<?= htmlspecialchars($zapato['nombre']) ?>">
                ...
                <a href="carrito.php?id=<?=$zapato["id"]?>">Añadir al carrito</a> <!--Este enlace nos manda al archivo carrito.php y mandamos por url el id(con el id ya podemos sacar informacion de solo ese producto de la base de datos)-->
            </div>
        <?php endwhile; ?>
    </div>
</main>
