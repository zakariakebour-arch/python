<?php
    ...
    //Como paso importante y para evitar errores,verificaamos si realmente se recibio el id del producto,con este paso evitamos crear un carrito sin iniciar sesion en la app
    if(!isset($_GET["id"])){
